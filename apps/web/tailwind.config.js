	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				dim: {
					technical: 'hsl(var(--dim-technical))',
					execution: 'hsl(var(--dim-execution))',
					collaboration: 'hsl(var(--dim-collaboration))',
					consistency: 'hsl(var(--dim-consistency))',
					innovation: 'hsl(var(--dim-innovation))',
				},
			},
			borderRadius: {
				lg: 'var(--radius)',
